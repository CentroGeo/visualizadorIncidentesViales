                ...
                tags$div(
                  ...
                  tags$ul(
                    ...
                    tags$li(
                      strong("Número de Registros"),
                      " – ",
                      textOutput(outputId = "c5_cuantos", inline = TRUE)
                    ),
                    tags$li(
                      strong("Periodo Temporal"),
                      " – ",
                      ...
                      " a ",
                      textOutput(outputId = "c5_cuando2", inline = TRUE)
                    )
                  )
                ),
                tags$div(style = "height: 15px;")
              ...
              tags$div(
                ...
                tags$ul(
                  ...
                  tags$li(
                    ...
                    " a ",
                    textOutput(outputId = "axa_cuando2", inline = TRUE)
                  )
                )
              ),
              tags$div(style = "height: 15px;")
            ...
            column(
              ...
              tags$table(
                ...
                tags$tr(
                  tags$td("alcaldia",
                    class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Nombre de la alcaldia donde ocurrió el siniestro",
                    class = "diccionario"),
                  tags$td("Texto", class = "diccionario"),
                  class = "diccionario"
                ),
                tags$tr(
                  tags$td("causa_siniestro",
                      class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Descripción del tipo de percance ocurrido",
                      class = "diccionario"),
                  tags$td(
                      "7 Causas Posibles (",
                      tags$span(id = "bd_siniestro-axa",
                          tags$u("Ver"),
                          style = "color: #00AA5A;"
                      ),
                      ")",
                ...
                tags$tr(
                  tags$td("tipo_vehiculo",
                      class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Vehículo involucrado en el percance vial",
                      class = "diccionario"),
                  tags$td("4 Vehículos Posibles (",
                      tags$span(id = "bd_vehiculo-axa",
                          tags$u("Ver"),
                          style = "color: #00AA5A;"
                      ),
                      ")",
                ...
                tags$tr(
                  tags$td("color", class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Color del vehículo asegurado",
                    class = "diccionario"),
                  tags$td("Texto", class = "diccionario"),
                  class = "diccionario"
                ),
                ...
                tags$tr(
                  tags$td("nivel_dano_vehiculo",
                    class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Grado de daño al vehículo en el percance vial",
                    class = "diccionario"),
                  tags$td("Texto (Alto, Medio, Bajo y Sin Daños)",
                    class = "diccionario"),
                  class = "diccionario"
                ),
                tags$tr(
                  tags$td("punto_impacto",
                    class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Parte del vehículo donde ocurrió el daño",
                      class = "diccionario"),
                  tags$td(
                    "Texto (Frontal, Trasero, Lateral Derecho o Lateral Izquierdo)",
                    class = "diccionario"),
                  class = "diccionario"
                ),
                tags$tr(
                  tags$td("ao", class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Año en que se registró el percance vial. No necesariamente corresponde al año de ocurrencia",
                    class = "diccionario"),
                  tags$td("Entero", class = "diccionario"),
                  class = "diccionario"
                ),
                tags$tr(
                  tags$td("mes",
                      class = "diccionario dicc_center dicc_rndm"),
                  tags$td(
                    "Mes en que registró el percance vial. No necesariamente corresponde al mes de ocurrencia",
                    class = "diccionario"),
                  tags$td("Entero", class = "diccionario"),
                  class = "diccionario"
                ),
                tags$tr(
                  tags$td("dia_numero",
                    class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Día en que registró el percance. No necesariamente correpsonde al día de ocurrencia",
                    class = "diccionario"),
                  tags$td("Entero", class = "diccionario"),
                  class = "diccionario"
                ),
                tags$tr(
                  tags$td("dia",
                    class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Día de la semana en la que se registró el percance",
                      class = "diccionario"),
                ...
                tags$tr(
                  tags$td("hora",
                    class = "diccionario dicc_center dicc_rndm"),
                  tags$td(
                    "Hora de ocurrencia del percance vial. No necesariamente correpsonde a la hora de ocurrencia",
                    class = "diccionario"),
                  tags$td("Entero", class = "diccionario"),
                  class = "diccionario"
                ),
                tags$tr(
                  tags$td("lesionados",
                    class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Cantidad de personas lesionadas en el siniestro",
                      class = "diccionario"),
                  tags$td("Entero", class = "diccionario"),
                  class = "diccionario"
                ),
                tags$tr( 
                  tags$td("edad_lesionado",
                    class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Corresponde a la edad de cada lesionado",
                  class = "diccionario"),
                  tags$td("Entero", class = "diccionario"),
                  class = "diccionario"
                ),
                ...
                tags$tr(
                  tags$td("genero_lesionado",
                     class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Corresponde al género de cada lesionado",
                    class = "diccionario"),
                  tags$td("Texto", class = "diccionario"),
                  class = "diccionario"
                ),
                ...
                tags$tr(
                  tags$td("hospitalizado", 
                      class = "diccionario dicc_center dicc_rndm"),
                  tags$td("Confirma si cada lesionado fue o no hospitalizado",
                    class = "diccionario"),
