  ...
  tagList(
      ...
      shinydashboard::box(
        ...
        tabsetPanel(
          ...
          #         style = "font-size: 18pt; color: #848888; text-align: left;",
          #         tags$p(
          #           tags$img(src = "www/repubikla2.png", style = "height: 85px; float: right;"),
          #           strong("Repubikla")
          #         )
          #       ),
          #       tags$div(style = "height: 15px;"),
          ...
          #         style = "text-align: justify; font-size: 12pt; color: #697070;",
          #         tags$ul(
          #           tags$li("Repubikla es una plataforma de mapeo alimentada por ciudadanos que con una estrategia de crowdsourcing busca generar y centralizar datos sobre la movilidad no motorizada en las ciudades."),
          ...
          #         style = "text-align: justify; font-size: 12pt; color: #697070;",
          #         tags$ul(
          #           tags$li(strong("Fuente"), " – ", tags$a("Página Oficial Repubikla", href = "https://repubikla.herokuapp.com/")),
